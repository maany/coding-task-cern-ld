...
def get_x_axis(indexed_mountains):
    left_sorted_mountains = [('left', mountain['id'], mountain['left']) for mountain in sort_mountains(indexed_mountains, left_index=True)]
    right_sorted_mountains = [('right', mountain['id'], mountain['right']) for mountain in sort_mountains(indexed_mountains, left_index=False)]
